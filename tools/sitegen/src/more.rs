...
pub const SLOTS: &[Slot] = &[
    ...
    Slot { class: "keyword",       covers: "fn let const mut self impl pub &hellip;", dark: "#FFB700", light: "#F55600" },
    ...
    Slot { class: "type-return",   covers: "any type after ->",                       dark: "#8CF584", light: "#00FF7B" },
    Slot { class: "type-def",      covers: "the name at struct/enum/trait/type X",    dark: "#1FFF9E", light: "#1189DF" },
    Slot { class: "variable",      covers: "every binding, param, closure param",     dark: "#85FDFF", light: "#029497" },
    Slot { class: "type",          covers: "struct, enum, primitive, alias — at use", dark: "#00DDFA", light: "#2EE7FF" },
    Slot { class: "field",         covers: "field def, x.field, .0, enum variants",   dark: "#A8E2FF", light: "#179674" },
    ...
    Slot { class: "fn-def",        covers: "the name at fn X(&hellip;), all kinds",   dark: "#B899FF", light: "#FF5C7A" },
